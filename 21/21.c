/* 	21.c: 						Write a program that asks the user to input any number of words. Reverse the order of the letters in each word 
*								and print them back out to the user.
* 	Author: 					Andrew Doyle
...
int main(void)
{
	...
	fgets(input, 100, stdin);					/* scan input using fgets and store it in character array called input(100 characters long),*/
